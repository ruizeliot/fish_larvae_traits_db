...
To support research on the early life stages of marine fishes, we compiled a comprehensive database of 35 traits (7 qualitative and 28 quantitative) describing developmental, behavioral, and ecological aspects of the pelagic phase. We focused on traits most relevant to pelagic dispersal processes and the parameterization of biophysical dispersal models. The database includes 314 records on age and size at settlement (including 207 unpublished entries), in situ measurements of swimming performance from the Atlantic and Indian Oceans, and 907 unpublished records on vertical position in the water column. Considered together, dispersive traits datasets comprise 47,193 records across 6,908 marine fish species, representing 1,935 genera, 365 families, and 59 orders, sourced from 3,530 references.
