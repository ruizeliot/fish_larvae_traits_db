...
| NB_OIL_GLOBULE            | character  | 85.1       |                                                                         | Number or range of oil globule(s) present in the egg. Evolving number of oil globules through time (e.g. numerous collapsing into one) were given as range. |
...
| EGG_VOLUME_MIN            | numeric    | 81         | Mean: 4.75, Range: 0.00 - 1767.15                                      | Minimum egg volume in mm3. If not already provided in the source study, it was computed as similarly that EGG_VOLUME_MEAN but considering EGG_L_MIN and EGG_W_MIN |
| EGG_VOLUME_MAX            | numeric    | 81         | Mean: 12.87, Range: 0.02 - 9202.77                                     | Maximum egg volume in mm3. If not already provided in the source study, it was computed as similarly that EGG_VOLUME_MEAN but considering EGG_L_MAX and EGG_W_MAX |
...
| YOLK_VOLUME_MEAN          | numeric    | 94.7       | Mean: 12.11, Range: 0.01 - 2364.92                                     | Mean yolk volume in mm3. It was computed considering yolk in egg is spherical: "(4/3) * pi * (EGG_L_MEAN/2)^3". |
| YOLK_VOLUME_MIN           | numeric    | 99.3       | Mean: 1.34, Range: 0.01 - 5.58                                         | Minimum yolk volume in mm3. It was computed considering yolk in egg is spherical: "(4/3) * pi * (EGG_L_MEAN/2)^3". |
| YOLK_VOLUME_MAX           | numeric    | 99.3       | Mean: 2.37, Range: 0.06 - 11.49                                        | Maximum yolk volume in mm3. It was computed considering yolk in egg is spherical: "(4/3) * pi * (EGG_L_MEAN/2)^3". |
| YOLK_VOLUME_TYPE          | categorical| 94.7       | Categories: Inferred from diameter (assuming yolk is spherical)         | Column precising whether the yolk volume was inferred from diameter (assuming it was spherical) or it was directly provided |
...
| OIL_GLOBULE_VOLUME_MIN    | numeric    | 95.9       | Mean: 0.01, Range: 0.00 - 0.66                                         | Minimum oil globule volume in egg (in mm3). It was computed if there was only 1 oil globule, considering it is spherica: "(4/3) * pi * (EGG_L_MEAN/2)^3". |
...
| OIL_GLOBULE_VOLUME_TYPE   | categorical| 89.5       | Categories: Inferred from diameter (0 or 1 oil globule)                 | Column precising whether the oil globule volume was inferred from diameter or it was directly provided |
...
| FLEXION_PARTICULARITY     | categorical| 96.7       | Categories: Does not occur; Flexion prior to hatching                   | Indicates any particularities related to flexion, such as its absence or occurrence before hatching |
...
| PERIOD                        | categorical| 0          | Categories: Day; Night                                                 | Time period (day or night) when stratified sampling was carried out         |
